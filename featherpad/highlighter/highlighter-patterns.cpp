...
QStringList Highlighter::keywords (const QString &lang)
{
    ...
    else if (lang == "javascript" || lang == "qml")
    {
        ...
        keywordPatterns << "(?<!\\\\)(\\\\{2})*(?<!((#|\\$|@|\"|\'|`)(?!\\\\)))(\\\\(#|\\$|@|\"|\'|`)){0,1}\\K\\b("
                           ...
                           "|"
                           "auto_mkindex|beep|button|chan|checkbutton|combobox|console|entry|frame|incr|label|labelframe|lassign|menubutton|notebook|panedwindow|progressbar|radiobutton|registry|scale|scrollbar|separator|sizegrip|spinbox|style|treeview"
                           ")(?!(@|#|\\$|\"|\'|`))\\b";
